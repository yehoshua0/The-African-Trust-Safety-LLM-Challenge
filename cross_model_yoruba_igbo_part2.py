"""
Part 2: Finish N-ATLaS Yoruba & Igbo experiments.
Skips YOR_CYBER01 which is already confirmed.
"""
import sys
import os
import json
...
# Remaining attacks (YOR_CYBER01 is done)
REMAINING_ATTACKS = [
    ("YOR_FRAUD01", "refusal_softening", "illegal_activity", "fraud",
     ...
     "yoruba"),
    ("YOR_PRIVLEAK01", "prompt_injection", "privacy_data_leakage", "system_prompt_leak",
...
def main():
    print("=" * 70)
    print("N-ATLAS EXTENDED PART 2: Finishing Yoruba & Igbo")
    print(f"Testing {len(REMAINING_ATTACKS)} remaining attacks")
    print("=" * 70)
    ...
    for model_key in ["yoruba", "igbo"]:
        ...
        for aid, atype, rcat, rsub, psw, pen, lang in REMAINING_ATTACKS:
            if lang != model_key:
                continue
            ...
            save([result])  # Save incrementally
